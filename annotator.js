...
getAnnotations = function (text, cb) {
	...
	request.post(submitUrl, {form: params}, function(error, response, body){
		...
		fs.writeFile('./output.xml', response.body, function(){
